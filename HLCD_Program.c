 ...
 */
  ...
  */
  ...
  {
	  /*String pointer*/
	  volatile u8 *Local_u8StringData = (u8 *)Copy_u32StringDataPtr;
	  /*single digit*/
	  volatile u8  Local_u8Digit        = 0;
	  /*number value*/
	  volatile u32 Local_u32NumberValue = 0;
	  /*remainder used in number display calculations*/
	  volatile u32 Local_u32Remainder   = 0;
